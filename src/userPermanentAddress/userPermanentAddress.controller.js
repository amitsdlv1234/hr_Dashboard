const UserPermanentAddressDetailsRepository = require('./model/userPermanentAddress.modal.repository');
const AddService = require('./services/PermanentAddressData.add.service');
...
exports.addAddressDetails=async(req,res)=>{
    try {
        ...
        const userPermanentAddressDetailsRepository= new UserPermanentAddressDetailsRepository();
        const present=await userPermanentAddressDetailsRepository.checkUserPermanentAddressDetailsExists(userId);
       console.log(present)
